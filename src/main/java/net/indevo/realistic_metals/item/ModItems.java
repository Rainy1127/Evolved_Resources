...
import net.indevo.realistic_metals.item.custom.HammerItem;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, Realistic_Metals.MOD_ID);
    ...
    public static final RegistryObject<Item> Osmium_Hammer = ITEMS.register("osmium_hammer",
            () -> new HammerItem(ModToolTiers.OSMIUM, 1, -2.8F, new Item.Properties().durability(2048)));
